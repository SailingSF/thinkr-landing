  ...
  return (
    <section className="pb-2 pt-8 sm:pt-16 text-center">
      <div className="container mx-auto px-4">
        ...
        <p className="text-xl sm:text-2xl lg:text-[32px] font-normal mb-8">
          <span className="text-gray-500">Save time with </span>
          <span className="text-primary">one-click AI Agents.</span>
        </p>
