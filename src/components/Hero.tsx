  ...
  return (
    <section className="pb-8 sm:pb-12 md:pb-16 lg:pb-20 pt-6 sm:pt-8 md:pt-12 lg:pt-16 text-center">
      <div className="container mx-auto px-4">
        <h1 className="text-[36px] sm:text-4xl md:text-[62px] lg:text-[50px] xl:text-[52px] 2xl:text-[75px] font-medium mb-4 sm:mb-6 max-w-[1000px] mx-auto leading-[1.15] sm:leading-tight">
