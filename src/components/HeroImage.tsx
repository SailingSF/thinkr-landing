        ...
        <div className="relative w-full mx-auto">
          <div className="bg-gray-100 rounded-[16px] md:rounded-[24px] p-3 pb-8 md:p-6 md:pb-16">
            <div className="relative w-full -mt-2 md:-mt-4">
              ...
              {/* Feature indicators */}
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-y-6 md:gap-8 lg:gap-4 mt-2 md:-mt-6 lg:-mt-16 px-2 md:px-20 lg:px-28">
                <div className="flex flex-row md:flex-col items-start md:items-center p-2 md:p-0">
                  <div className="flex items-center justify-center h-10 md:h-12 min-w-[40px] md:mb-4">
                  ...
                  <p className="text-[14px] font-normal text-[#8d8a8b] leading-tight text-left md:text-center pl-4 md:pl-0">Connect your shopify store and other applications</p>
                </div>
                ...
                <div className="flex flex-row md:flex-col items-start md:items-center p-2 md:p-0">
                  ...
                  <p className="text-[14px] font-normal text-[#8d8a8b] leading-tight text-left md:text-center pl-4 md:pl-0">Set clear goals and let <strong>thinkr</strong> scale your store</p>
                </div>
                ...
                <div className="flex flex-row md:flex-col items-start md:items-center p-2 md:p-0">
                  ...
                  <p className="text-[14px] font-normal text-[#8d8a8b] leading-tight text-left md:text-center pl-4 md:pl-0">Approve personalized strategies to grow your business</p>
                </div>
                ...
                <div className="flex flex-row md:flex-col items-start md:items-center p-2 md:p-0">
                  ...
                  <p className="text-[14px] font-normal text-[#8d8a8b] leading-tight text-left md:text-center pl-4 md:pl-0">Automate and grow with <strong>thinkr&apos;s</strong> intelligent planning</p>
                </div>
              </div>
            </div>
          </div>
