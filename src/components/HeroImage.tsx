            ...
            <div className="relative w-full -mt-4 md:-mt-6">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 md:gap-8 lg:gap-4 -mt-0 md:-mt-8 lg:-mt-18 px-2 md:px-24 lg:px-32">
                <div className="text-center flex flex-col items-center">
                  ...
                  <p className="text-[14px] font-normal text-[#8d8a8b] leading-tight px-2">Connect your shopify store and other applications</p>
                </div>
                ...
                <div className="text-center flex flex-col items-center">
                  ...
                  <p className="text-[14px] font-normal text-[#8d8a8b] leading-tight px-2">Set clear goals and let <strong>thinkr</strong> scale your store</p>
                </div>
                ...
                <div className="text-center flex flex-col items-center">
                  ...
                  <p className="text-[14px] font-normal text-[#8d8a8b] leading-tight px-2">Approve personalized strategies to grow your business</p>
                </div>
                ...
                <div className="text-center flex flex-col items-center">
                  ...
                  <p className="text-[14px] font-normal text-[#8d8a8b] leading-tight px-2">Automate and grow with <strong>thinkr&apos;s</strong> intelligent planning</p>
                </div>
              </div>
            </div>
          </div>
