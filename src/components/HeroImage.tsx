        ...
        <div className="relative w-full">
          <div className="relative w-full aspect-[16/9]">
            <Image
              ...
              fill
              className="object-contain rounded-lg px-24"
              priority
            />
          </div>
          
          {/* Feature indicators */}
          <div className="flex gap-12 justify-center mt-4 px-24">
            <div className="text-center">
              <div className="mb-4 mx-auto flex items-center justify-center">
                <svg width="60" height="60" viewBox="0 0 34 42" fill="none" xmlns="http://www.w3.org/2000/svg">
              ...
              <p className="text-md text-gray-600">Connect your Shopify store,</p>
              <p className="text-md text-gray-300">other marketing apps and software</p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-md text-gray-600">Set goals</p>
              <p className="text-md text-gray-300">and have thinkr tell you how to achieve them</p>
            </div>
            
            <div className="text-center">
              <div className="mb-4 mx-auto flex items-center justify-center">
                <svg width="60" height="60" viewBox="0 0 38 44" fill="none" xmlns="http://www.w3.org/2000/svg">
              ...
              <p className="text-md text-gray-600">Get recommendations</p>
              <p className="text-md text-gray-300">and personalized step by step plans on how to execute</p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-md text-gray-600">Save time and grow your business</p>
              <p className="text-md text-gray-300">with automations and planning from thinkr&apos;s AI</p>
            </div>
          </div>
        </div>
      </div>
