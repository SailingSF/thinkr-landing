    ...
    <section className="py-20 px-4">
      <div className="container mx-auto max-w-7xl">
        <div className="text-center mb-16">
          <h2 className="text-4xl font-bold mb-4">AI that goes beyond search and chat.</h2>
          <p className="text-xl text-muted-foreground">Run multiple tasks and actions in seconds, across apps.</p>
        </div>
