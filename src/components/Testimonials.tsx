    ...
    <section className="py-16 sm:py-20 bg-white font-sans">
      <div className="container mx-auto px-4">
        ...
        <div className="bg-gradient-to-br from-green-50 to-blue-50 rounded-3xl p-8 lg:p-12">
          <div className="mb-8">
            <h3 className="text-2xl font-semibold text-gray-900 font-sans">{t('testimonials.shopifyTitle') as string}</h3>
          </div>
              ...
              >
                ...
                >
                  <div className="flex items-center gap-2">
                    <span className="text-sm font-medium">{t('testimonials.shopifyAppStore') as string}</span>
                  </div>
                  {t('testimonials.viewAllReviews') as string}
